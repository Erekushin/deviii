...
class _HeightPageState extends State<HeightPage> {
  ...
  getWeight() {
    ...
    Services()
      ...
      setState(() {
        GlobalVariables.totalHeight.value = res['result']['items'][0]['fval']
                    .toString()
                    .length ==
                2
        ...
        storage.write(
            'totalHeigth', res['result']['items'][0]['fval'].toString());
      });
    });
  }
    ...
    Services()
      ...
      (data) {
        ...
        if (response['code'] == 200) {
          GlobalVariables.totalHeight.value = weightValue;
          var storage = GetStorage();
          storage.write('totalHeigth', GlobalVariables.totalHeight.value);
          modal();
        } else {
          // Get.back();
          Get.snackbar(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Obx(
              () => Text(
                "${GlobalVariables.totalHeight.value}",
                style: const TextStyle(
